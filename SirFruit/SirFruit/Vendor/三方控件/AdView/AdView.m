...
//  广告循环滚动效果
//
//  Created by yong on 15/8/13.
//  Copyright (c) 2015年 王俊丽. All rights reserved.
//
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _leftImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, kAdViewWidth, kAdViewHeight-Cha)];
        [_adScrollView addSubview:_leftImageView];
        
        _centerImageView = [[UIImageView alloc]initWithFrame:CGRectMake(kAdViewWidth, 0, kAdViewWidth, kAdViewHeight-Cha)];
        ...
        _rightImageView = [[UIImageView alloc]initWithFrame:CGRectMake(kAdViewWidth*2, 0, kAdViewWidth, kAdViewHeight-Cha)];
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    else if (PageControlShowStyle == UIPageControlShowStyleCenter)
    {
        ...
        _pageControl.center = CGPointMake(kAdViewWidth/2.0, kAdViewHeight - 8);
    }
    else
    {
